...
// console.log(Myarr.includes(5)); // boolean eturn
...
console.log(Array.isArray("Hitesh")) // question asked wheather it is array or not
console.log(Array.from("Hitesh")) // string converted to array
console.log(Array.from({name: "hitesh"})) // interesting wheather to specify key ka array bnana hai ya value ka
